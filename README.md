...
flowchart TD
    ...
    subgraph L1["🔬 Layer 1 · Physics Foundation"]
        direction LR
        P01["🔬 01 Photon &Imaging Physics"]
        P02["📡 02 CMOSImage Sensor"]
    end
    ...
    subgraph L3["⚙️ Layer 3 · ISP Pipeline Hub"]
        P05["⚙️ 05 ISP Pipeline━━━━━━━━━━━🔗 Central Processing Hub"]
    end

    %% ──────── Layer 4A: 3A Algorithms ────────
    subgraph L4A["☀️ Layer 4A · 3A Algorithms"]
        direction LR
        P06["☀️ 06 AutoExposure"]
        P07["🎨 07 AutoWhite Balance"]
        P08["🎯 08 AutoFocus"]
    end
    ...
    subgraph L4B["🧩 Layer 4B · Core Processing Stages"]
        ...
        P11 --> P12["🌈 12 ColorCorrection"]
        P12 --> P13["🎛️ 13 ToneMapping"]
    end
    ...
    subgraph L6["🤖 Layer 6 · Next Generation"]
        direction LR
        P14["📐 14 ComputationalPhotography"]
        P15["🤖 15 AI ISP━━━━━━━━━🔥 Frontier"]
    end
